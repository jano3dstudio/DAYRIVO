...
Stand: 17.09.2026. Ergänzung Monatsabschluss: siehe BILLING.md. Die frühere Beschränkung auf Kunden/Projekte gilt nur für die Eintragsauswahl; der neue lokale Pilot liest zusätzlich Kundenbuchungen und speichert interne Entwürfe. Jona hat den ersten echten Lesetest bestätigt: Kunden und Projekte sind sichtbar. Die anschließende Einbindung in DAYRIVO ist implementiert und mit isoliertem Browser, echtem Loopback-Dienst und künstlichen API-Antworten geprüft. Ihre erste Nutzung mit Jonas echten Daten steht noch aus.
